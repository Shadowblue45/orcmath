...
public class SimonScreenFahad extends ClickableScreen implements Runnable {
	...
	private ButtonInterfaceFahad getAButton() {
		return new ButtonDavid(0, 0, 40, 40, "", Color.blue, null);
	}
	...
	//WAIT FOR PARTNER
	private MoveInterfaceFahad getMove(int bIndex) {
	    return new MoveDavid(buttons[bIndex]);
	}
}
